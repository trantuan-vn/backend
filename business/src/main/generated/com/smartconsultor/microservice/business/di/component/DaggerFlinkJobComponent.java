...
import com.smartconsultor.microservice.business.di.module.ApplicationModule_ProvideBusinessDispatcherFactory;
...
public final class DaggerFlinkJobComponent {
  ...
  private static final class FlinkJobComponentImpl implements FlinkJobComponent {
    ...
    Provider<BusinessDispatcher> provideBusinessDispatcherProvider;
    ...
    TransactionProcessFunction transactionProcessFunction() {
      return new TransactionProcessFunction(provideBusinessDispatcherProvider.get());
    }

    @SuppressWarnings("unchecked")
    private void initialize(final ApplicationModule applicationModuleParam,
        final FlinkModule flinkModuleParam) {
      this.provideBusinessDispatcherProvider = DoubleCheck.provider(ApplicationModule_ProvideBusinessDispatcherFactory.create(applicationModuleParam));
