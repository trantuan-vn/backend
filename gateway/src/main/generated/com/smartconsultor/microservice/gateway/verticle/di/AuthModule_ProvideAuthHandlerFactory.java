...
public final class AuthModule_ProvideAuthHandlerFactory implements Factory<AuthHandler> {
  ...
  public AuthModule_ProvideAuthHandlerFactory(AuthModule module,
  ...
  public static AuthModule_ProvideAuthHandlerFactory create(AuthModule module,
      Provider<ExchangeCodeUseCase> exchangeCodeUseCaseProvider,
      Provider<RefreshUseCase> refreshUseCaseProvider,
      Provider<LogoutUseCase> logoutUseCaseProvider) {
    return new AuthModule_ProvideAuthHandlerFactory(module, exchangeCodeUseCaseProvider, refreshUseCaseProvider, logoutUseCaseProvider);
  }

  public static AuthHandler provideAuthHandler(AuthModule instance,
